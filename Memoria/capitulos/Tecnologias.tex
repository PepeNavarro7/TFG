...
\begin{itemize}
	\item \textbf{Host}: la CPU, donde vive el programa principal, el runtime CUDA, y la lógica de control
	\item \textbf{Device}: la GPU, donde viven los kernels, la memoria global, los SM, y los warps
\end{itemize}

\begin{figure}[H]
	\includegraphics[width=\linewidth]{imagenes/CUDA-Host-Device.png}
	\caption{Modelo host-device de CUDA}
