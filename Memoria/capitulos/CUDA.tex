...
Sin embargo, como podemos ver en los resultados de nuestras mediciones, la introducción de los \textit{Graph} no solo no representó una mejora en los tiempos, sino que conforme aumentaban los tamaños, se establecía en un 20\% más lenta que la versión sin \textit{Graph}.
...
Si los hilos crean una variable local, podrán accederse entre ellos a esas variables. Esto resulta útil en implementaciones como el algoritmo \ref{alg:KernelAdvDiff1d}, en el que un mismo thread hace varios accesos a memoria global, y esto podríamos sustituirlo por un único acceso a memoria global, y varios shuffle entre hilos.
