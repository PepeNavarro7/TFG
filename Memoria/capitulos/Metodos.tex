...
Brusselator1D, el modelo brusselator es un tipo de modelo de reacción-difusión que fue desarrollado por la Brussels School. Este sistema está diseñado para analizar el comportamiento de sistemas químicos que presentan oscilación no linear. \cite{Hunsdorfer2003}


Brusselator2D, este modelo es similar a su versión unidimensional, pero incorpora una componente extra reactiva. Además, está discretizado uniformemente en una malla de NxN puntos.