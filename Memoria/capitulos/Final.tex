...
Para las mediciones que se muestran en el presente proyecto se utilizó ese mismo código fuente ejecutado desde la máquina \textit{ILEX} perteneciente a la Universidad de Granada.