...
\begin{document}
	...
	\input{capitulos/Introduccion} % Capitulo 1
	\input{capitulos/Conceptos} % Capitulo 2.1 a 2.4
	\input{capitulos/Metodos} % Capitulo 2.5 y 2.6
	\input{capitulos/Tecnologias} % Capitulo 2.7 y 2.8
	\input{capitulos/OpenMP} % Capitulo 3
	\input{capitulos/CUDA} % Capitulo 4
	\input{capitulos/Final} %Capitulos 5, 6 y 7
