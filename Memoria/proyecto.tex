...
% Packages que usamos
\usepackage[utf8]{inputenc} %idioima
...
\addto\captionsspanish{ \renewcommand{\listtablename}{Glosario de Tablas} }
\addto\captionsspanish{ \renewcommand{\listfigurename}{Glosario de Imágenes} }
