...
\usepackage[
colorlinks=true,
linkcolor=red,      % citas y referencias internas
urlcolor=green,       % URLs
...
% Comandos para crear capitulos y secciones que no tengan numero pero sí aparezcan en el índice
