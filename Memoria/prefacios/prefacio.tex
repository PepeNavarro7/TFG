...
%\vspace{0.7cm}
\vspace{0.7cm}
\noindent\textbf{Palabras clave}: {\sloppy Métodos Numéricos, Ecuaciones Diferenciales Ordinarias, Paralelismo, Runge-Kutta, Adams-Bashforth, Adams-Bashforth-Moulton, CUDA, OpenMP\par}
\vspace{0.7cm}
...
%\vspace{0.7cm}
\noindent\textbf{Keywords}: {\sloppy Numerical Methods, Ordinary Differential Equations, Parallelism, Runge-Kutta, Adams-Bashforth, Adams-Bashforth-Moulton, CUDA, OpenMP\par}
