#ifndef BRUSSELATOR1DV2_H
#define BRUSSELATOR1DV2_H
...
class brusselator1dv2:public Problema{
...
public:
    ...
    brusselator1dv2(const int &nx_points, const int &threads):
        Problema(nx_points*2.0, "Brusselator_1Dv2", (1.0/(nx_points+1.0)), dim3( (nx_points*2.0+threads-1)/threads, 1, 1 ), dim3(threads/2,2,1)),
...
private:
    ...
    inline int idx(const int &i, const int &j) const { return i + j * nx; };
};
